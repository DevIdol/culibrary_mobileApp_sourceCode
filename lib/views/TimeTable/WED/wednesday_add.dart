...
class AddWednesdayClass extends StatefulWidget {
  const AddWednesdayClass({Key? key}) : super(key: key);

  @override
  _AddWednesdayClassState createState() => _AddWednesdayClassState();
}

class _AddWednesdayClassState extends State<AddWednesdayClass> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer(builder: (context, ThemeModel themeNotifier, child) {
      ...
      return Scaffold(
        ...
        appBar: inputAppBar(
            themeNotifier, _cardColor, _fontColor, 'Add Wednesday Class'),
                ...
                children: [
                  ...
                  buttonWidget(_iconColor, () {
                    if (formKey.currentState!.validate()) {
                      wedDao.addWed(Wed(_startTime.text, _endTime.text,
