...
class AddMondayClass extends StatefulWidget {
  const AddMondayClass({Key? key}) : super(key: key);

  @override
  _AddMondayClassState createState() => _AddMondayClassState();
}

class _AddMondayClassState extends State<AddMondayClass> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer(builder: (context, ThemeModel themeNotifier, child) {
      ...
      return Scaffold(
        ...
        appBar: inputAppBar(
            themeNotifier, _cardColor, _fontColor, 'Add Monday Class'),
                ...
                children: [
                  ...
                  buttonWidget(_iconColor, () {
                    if (formKey.currentState!.validate()) {
                      monDao.addMon(Mon(_startTime.text, _endTime.text,
