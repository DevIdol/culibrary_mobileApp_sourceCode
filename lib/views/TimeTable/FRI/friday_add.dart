...
class AddFridayClass extends StatefulWidget {
  const AddFridayClass({Key? key}) : super(key: key);

  @override
  _AddFridayClassState createState() => _AddFridayClassState();
}

class _AddFridayClassState extends State<AddFridayClass> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer(builder: (context, ThemeModel themeNotifier, child) {
      ...
      return Scaffold(
        ...
        appBar: inputAppBar(
            themeNotifier, _cardColor, _fontColor, 'Add Friday Class'),
                ...
                children: [
                  ...
                  buttonWidget(_iconColor, () {
                    if (formKey.currentState!.validate()) {
                      friDao.addFri(Fri(_startTime.text, _endTime.text,
