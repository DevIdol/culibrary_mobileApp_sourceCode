...
class AddThursdayClass extends StatefulWidget {
  const AddThursdayClass({Key? key}) : super(key: key);

  @override
  _AddThursdayClassState createState() => _AddThursdayClassState();
}

class _AddThursdayClassState extends State<AddThursdayClass> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer(builder: (context, ThemeModel themeNotifier, child) {
      ...
      return Scaffold(
        ...
        appBar: inputAppBar(
            themeNotifier, _cardColor, _fontColor, 'Add Thursday Class'),
                ...
                children: [
                  ...
                  buttonWidget(_iconColor, () {
                    if (formKey.currentState!.validate()) {
                      thuDao.addThu(Thu(_startTime.text, _endTime.text,
